...
def _pergunta_8(df, modelo_pack):
    ...
    st.markdown(
        "**Leitura:** IDA (0,79), IEG (0,75) e IPV (0,72) são os indicadores mais fortemente "
        "associados ao INDE, seguidos por IPP (0,54) e IAN (0,41). IAA (0,40) e, principalmente, "
        "IPS (0,20) têm associação bem mais fraca com a nota geral. Ou seja, desempenho "
        "acadêmico, engajamento e ponto de virada são as dimensões que mais acompanham a "
        "variação do INDE entre os alunos."
    )
